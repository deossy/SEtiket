package com.adorable.setiket.view.input
...
import com.adorable.setiket.viewmodel.InputDataViewModel
import kotlinx.android.synthetic.main.activity_input_data.*
import java.text.SimpleDateFormat
import java.util.*

class DataKapalActivity : AppCompatActivity() {
    val strAsal = arrayOf("Bandung","Jakarta", "Semarang", "Surabaya", "Bali")
    val strTujuan = arrayOf("Bandung","Jakarta", "Semarang", "Surabaya", "Bali")
    ...
    private fun setInputData() {
        btnCheckout.setOnClickListener {
            ...
            sTelp = inputTanggal.text.toString() //salah ga sie
            if (sNama.isEmpty() || sTanggal.isEmpty() || sTelp.isEmpty()
                ...
                if ( sAsal == "Bandung" && sTujuan == "Bandung"
                    || sAsal == "Jakarta" && sTujuan == "Jakarta"
    ...
    private fun setPerhitunganHargaTiket() {
        ...
        if (sAsal == "Jakarta" && sTujuan == "Semarang") {
            hargaDewasa = 400000
            hargaAnak = 40000
        } else if (sAsal == "Bandung" && sTujuan == "Jakarta") {
            hargaDewasa = 100000
            hargaAnak = 60000
